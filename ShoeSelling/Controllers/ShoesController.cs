...
namespace ShoeSelling.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShoeID,PhotoID,SizeID,ColorID,Price,OrderID,SeasonID")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShoeID,PhotoID,SizeID,ColorID,Price,OrderID,SeasonID")] Shoe shoe)
        {
            if (id != shoe.ShoeID)
            {
                return NotFound();
